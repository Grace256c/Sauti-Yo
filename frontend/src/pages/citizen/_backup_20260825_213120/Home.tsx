    ...
    <>
      ...
      <section className="relative isolate min-h-[calc(100svh-74px)] overflow-hidden">
        <img
          ...
          alt=""
          aria-hidden="true"
          className="legal-image absolute inset-0 -z-20 h-full w-full object-cover object-[68%_center] sm:object-center"
        />
        ...
        <div className="site-container flex min-h-[calc(100svh-74px)] items-center py-14 sm:py-16 lg:py-20">
          <div className="grid w-full items-center gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:gap-12">
            <div className="max-w-2xl animate-fade-up">
              ...
              <p className="mt-7 max-w-xl text-base leading-7 text-text-secondary sm:text-lg sm:leading-8">
                Sauti Yo helps you understand your rights, explore
                practical next steps and connect with appropriate
                support — through the web or a basic phone.
              </p>
            ...
            <div className="mx-auto w-full max-w-2xl lg:mx-0">
              <div className="image-frame">
                <img
                  ...
                  alt="Sauti Yo shown on smartphones"
        ...
        <div className="site-container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-text-secondary">
              You do not need to know the legal name for your problem.
              Start with the situation you are experiencing.
            </p>
          </div>
        ...
        <div className="site-container section-padding">
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {steps.map((step) => (
              ...
              >
                <span className="absolute right-4 top-2 heading-serif text-6xl font-bold text-gold/10">
                  {step.number}
                </span>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="mt-6 max-w-xl text-base leading-7 text-text-secondary">
                The same Rights-to-Action experience can reach people
                through different channels depending on their device,
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
            <div>
              ...
              <p className="mt-6 text-base leading-7 text-text-secondary">
                ...
                aggregated experiences without turning sensitive
                personal stories into public profiles.
              </p>
            ...
            <div className="flex items-center p-7 sm:p-10 lg:p-14">
              <div>
                ...
                <p className="mt-6 max-w-lg text-base leading-7 text-text-secondary">
                  ...
                  services when specialised, practical or urgent
