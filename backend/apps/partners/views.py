...
from .serializers import PublicPartnerMatchSerializer
...
class PublicPartnerMatchAPIView(APIView):
    ...
    def get(self, request):
        ...
        for organisation in organisations:
            config = (
                organisation.service_configuration
            )

            if category not in (
                config.rights_categories or []
            ):
                continue
            ...
            if language in (
                ...
                score += 20
                reasons.append(
                    f"Provides support in {language}"
                )
            ...
            data = {
                ...
                "website":
                    support_service.website,
                "districts_served":
                    config.districts_served or [],
                "nationwide":
                    config.nationwide,
                "languages":
                    config.languages or [],
                ...
                "rights_categories":
                    config.rights_categories or [],
                "support_types":
                    config.support_types or [],
                "free_services":
                    config.free_services,
                "appointment_required":
                    config.appointment_required,
                "availability_note":
                    config.availability_note,
                "score":
                    score,
                "reasons":
                    reasons,
